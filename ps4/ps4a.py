    ...
    while calculateHandlen(hand) != 0:
        ...
        if word == ".":
            ...
            if not isValidWord(word, hand, wordList):
                ...
                value = getWordScore(word, n)
                TotalScore += value
                print("{} earned {} points. Total: {} points\n".format(word, value, TotalScore))
                if calculateHandlen(updateHand(hand, word)) != 0:
                    playHand(updateHand(hand, word), wordList, n, TotalScore)
                else:
...
def playGame(wordList):
    ...
    while thegame != 'e':
        thegame = input('Enter n to deal a new hand, r to replay the last hand, or e to end game:')
        if thegame == 'n':
